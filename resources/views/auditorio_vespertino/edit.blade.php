...
<body>
	<div id="titulo">
		<p id="header">[Modificación] Auditorio Vespertino</p>
	</div>
<!------------------------------------------------------------*----------------------------------------------------------->
<br>
<br>

<form id="formulario_aula1" action="{{route('auditorio_vespertinoedit')}}" method="POST" enctype="multipart/form-data">
  {{csrf_field()}}
...
<input type="text" name="id_auditorio_ves" value="{{$auditorioves1->id_auditorio_ves}}" style="display:none" readonly>
<br>
  <div id="titulo_form">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Número y Nombre Practica" required="" value="{{$auditorioves1->nombreprac_auditorio_ves}}" name="nombreprac_auditorio_ves">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Unidad de Aprendizaje</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Unidad de Aprendizaje" required="" value="{{$auditorioves1->unidad_auditorio_ves}}" name="unidad_auditorio_ves">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control"rows="6" required="" value="{{$auditorioves1->desarrollo_auditorio_ves}}" name="desarrollo_auditorio_ves">{{$auditorioves1->desarrollo_auditorio_ves}}</textarea>
  </div>
 <br>
 <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" placeholder="Número de Alumnos" required="" value="{{$auditorioves1->numalumnos_auditorio_ves}}" name="numalumnos_auditorio_ves">
    </div>
  </div>
  <p style="font-size: 20px; font-weight: bold;">Formato 24Hrs</p>
   <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="datetime" class="form-control" name="start_date" value="{{$auditorioves1->start_date}}" class="date" readonly="">
    </div>
    <label class="col-sm-2 col-form-label">Fecha y Hora de Finalización</label>
    <div class="col-sm-4">
      <input type="datetime" class="form-control" name="end_date" value="{{$auditorioves1->end_date}}" class="date" readonly="">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="10" required="" value="{{$auditorioves1->observaciones_auditorio_ves}}" name="observaciones_auditorio_ves">{{$auditorioves1->observaciones_auditorio_ves}}</textarea>
  </div>
  <center>
    <br>
