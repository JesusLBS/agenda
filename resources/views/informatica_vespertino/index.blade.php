...
<html>
<head>
  <title>Informática Vespertino</title>
  <meta charset="utf-8">
...
<!------------------------------------------------------------*----------------------------------------------------------->
<div id="titulo">
    <p id="header">Laboratorio de Informática Vespertino</p>
</div>
<br>
<!------------------------------------------------------------*----------------------------------------------------------->
<div id="modal_form">
...
@include('contentsadmin.content3')
@else
@endif
...
<br>
<br>
<form id="formulario_aula1" action="{{route('informatica_vespertino1')}}" method="POST" enctype="multipart/form-data">
...
<div id="titulo_form">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Número y Nombre Practica" required="" name="nombreprac_infor_ves">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Unidad de Aprendizaje</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Unidad de Aprendizaje" required="" name="unidad_infor_ves">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control"rows="6" required="" name="desarrollo_infor_ves"></textarea>
  </div>
 <br>
 <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" placeholder="Número de Alumnos" required="" class='id' name="numalumnos_infor_ves" onkeypress="return numeros(event)">
    </div>
  </div>
  ...
  <div class="form-group row">
    <div class="col-sm-4">
      <input type="date" name="fecha_reservacion_infor_ves" class="form-control"   value="{{old('fecha_reservacion_infor_ves',$now->format('Y-m-d'))}}" readonly="">
    </div>
    <div class="col-sm-4">
      <input type="time" name="hora_reservacion_infor_ves" class="form-control"   value="{{old('hora_reservacion_infor_ves',$now->format('H:i:s'))}}" readonly="">
    </div>
  </div>
...
<p style="font-size: 16px; font-weight: bold;">Ejemplo: Formato de llenado: 07-06-2019 03:00 pm</p>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="10" required="" name="observaciones_infor_ves"></textarea>
  </div>
...
<br>
<br>
<form id="formulario_aula1" action="{{route('informatica_vespertino1_')}}" method="POST" enctype="multipart/form-data">
