...
<html>
<head>
  <title>Informática Matutino Modificación</title>
  <meta charset="utf-8">
...
<body>
	<div id="titulo">
		<p id="header">[Modificación] Laboratorio de Informática Matutino</p>
	</div>
<!------------------------------------------------------------*----------------------------------------------------------->
<br>
<br>

<form id="formulario_aula1" action="{{route('informatica_matutinoedit')}}" method="POST" enctype="multipart/form-data">
  {{csrf_field()}}
...
<input type="text" name="id_lab_infor_mat" value="{{$informatica_matutino1->id_lab_infor_mat}}" style="display:none" readonly>
<br>
  <div id="titulo_form">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Número y Nombre Practica" required="" value="{{$informatica_matutino1->nombreprac_infor_mat}}" name="nombreprac_infor_mat">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Unidad de Aprendizaje</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Unidad de Aprendizaje" required="" value="{{$informatica_matutino1->unidad_infor_mat}}" name="unidad_infor_mat">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control"rows="6" required="" value="{{$informatica_matutino1->desarrollo_infor_mat}}" name="desarrollo_infor_mat">{{$informatica_matutino1->desarrollo_infor_mat}}</textarea>
  </div>
 <br>
 <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" placeholder="Número de Alumnos" required="" value="{{$informatica_matutino1->numalumnos_infor_mat}}" name="numalumnos_infor_mat">
    </div>
  ...
  <p style="font-size: 20px; font-weight: bold;">Formato 24Hrs</p>
   <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input type="datetime" class="form-control" name="start_date" value="{{$informatica_matutino1->start_date}}" class="date" readonly="">
    </div>
    <label class="col-sm-2 col-form-label">Fecha y Hora de Finalización</label>
    <div class="col-sm-4">
      <input type="datetime" class="form-control" name="end_date" value="{{$informatica_matutino1->end_date}}" class="date" readonly="">
    </div>
  </div>
    <div class="form-group row">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="10" required="" value="{{$informatica_matutino1->observaciones_infor_mat}}" name="observaciones_infor_mat">{{$informatica_matutino1->observaciones_infor_mat}}</textarea>
  </div>
  <center>
    <br>
