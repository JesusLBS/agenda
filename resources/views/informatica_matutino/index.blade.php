...
<html>
<head>
  <title>Informática Matutino</title>
  <meta charset="utf-8">
...
<!------------------------------------------------------------*----------------------------------------------------------->
<div id="titulo">
    <p id="header">Laboratorio de Informática Matutino</p>
</div>
<br>
<!------------------------------------------------------------*----------------------------------------------------------->
<div id="modal_form">
...
@include('contentsadmin.content2')
@else
@endif
...
<br>
 ...
 <div>
    <table id="referencia" style="background-color: rgb();">
      <tr>
        <th>OCUPADO</th>
...
<br> 
<br>
<form id="formulario_aula1" action="{{route('informatica_matutino1')}}" method="POST" enctype="multipart/form-data">
...
<div id="info_documento">
  ...
  <div id="Campo2">
    <p>Revisión: 
      <select name="revision_infor_mat">
  ...
  <div id="Campo3">
    <p>Fecha de Aprovación: 
      <select name="fecha_apro_infor_mat">
...
<div id="titulo_form">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Número y Nombre Practica" required="" name="nombreprac_infor_mat">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Unidad de Aprendizaje</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Unidad de Aprendizaje" required="" name="unidad_infor_mat">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control"rows="6" required="" name="desarrollo_infor_mat"></textarea>
  </div>
 <br>
 <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" placeholder="Número de Alumnos" required="" name="numalumnos_infor_mat" onkeypress="return numeros(event)">
    </div>
  </div>
<p style="font-size: 20px; font-weight: bold;">Fecha y Hora de la Reservación:</p>
  <div class="form-group row">
    <div class="col-sm-4">
      <input type="date" name="" class="form-control"   value="{{old('fecha_reservacion_infor_mat',$now->format('Y-m-d'))}}" readonly="">
    </div>
    <div class="col-sm-4">
      <input type="time" name="" class="form-control"   value="{{old('hora_reservacion_infor_mat',$now->format('H:i:s'))}}" readonly="">
    </div>
  </div>
   <div class="form-group row">
  </div>
<p style="font-size: 20px; font-weight: bold;">Para el día:</p>
<p style="font-size: 16px; font-weight: bold;">Ejemplo: Formato de llenado: 07-06-2019 08:30 am</p>
  <div class="form-group row">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="10" required="" name="observaciones_infor_mat"></textarea>
  </div>
...
<br>
<br>
<form id="formulario_aula1" action="{{route('informatica_matutino1_')}}" method="POST" enctype="multipart/form-data">
...
<p style="font-size: 20px; font-weight: bold;">Fecha y Hora de la Reservación:</p>
  <div class="form-group row">
    <div class="col-sm-4">
      <input type="date" name="fecha_reservacion_infor_mat" class="form-control"   value="{{old('fecha_reservacion_infor_mat',$now->format('Y-m-d'))}}" readonly="">
    </div>
    <div class="col-sm-4">
      <input type="time" name="hora_reservacion_infor_mat" class="form-control"   value="{{old('hora_reservacion_infor_mat',$now->format('H:i:s'))}}" readonly="">
    </div>
  </div>
   <div class="form-group row">
  </div>
