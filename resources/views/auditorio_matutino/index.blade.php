...
<!------------------------------------------------------------*----------------------------------------------------------->
<div id="titulo">
    <p id="header">Auditorio Matutino</p>
</div>
<br>
<!------------------------------------------------------------*----------------------------------------------------------->
<div id="modal_form">
...
@include('contentsadmin.content8')
@else
@endif
<!------------------------------------------------------------*----------------------------------------------------------->
  <br> 
...
<br>
<br>
<form id="formulario_aula1" action="{{route('auditorio1')}}" method="POST" enctype="multipart/form-data">
...
<div id="titulo_form">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Número y Nombre Practica" required="" name="nombreprac_auditorio_mat">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Unidad de Aprendizaje</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Unidad de Aprendizaje" required="" name="unidad_auditorio_mat">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control"rows="6" required="" name="desarrollo_auditorio_mat"></textarea>
  </div>
 <br>
 <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" placeholder="Número de Alumnos" required="" name="numalumnos_auditorio_mat" onkeypress="return numeros(event)">
    </div>
  </div>
  <p style="font-size: 20px; font-weight: bold;">Fecha y Hora de la Reservación:</p>
  <div class="form-group row">
    <div class="col-sm-4">
      <input type="date" name="fecha_reservacion_auditorio_mat" class="form-control"   value="{{old('fecha_reservacion_auditorio_mat',$now->format('Y-m-d'))}}" readonly="">
    </div>
    <div class="col-sm-4">
      <input type="time" name="hora_reservacion_auditorio_mat" class="form-control"   value="{{old('hora_reservacion_auditorio_mat',$now->format('H:i:s'))}}" readonly="">
    </div>
  </div>
...
<p style="font-size: 16px; font-weight: bold;">Ejemplo: Formato de llenado: 07-06-2019 08:30 am</p>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="10" required="" name="observaciones_auditorio_mat"></textarea>
  </div>
...
<br>
<br>
<form id="formulario_aula1" action="{{route('auditorio1_')}}" method="POST" enctype="multipart/form-data">
...
@if(\Session::has('danger'))
      <div class="alert alert-danger alert-dismissible">
        <button type="button" class="close" data-dismiss="alert">×</button>
        <center>
        <p style="color: red; font-weight: bold; font-size: 1.4em">{{ \Session::get('danger')}}</p>
        </center>
      </div>
@endif
