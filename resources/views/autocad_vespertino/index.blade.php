...
<html>
<head>
  <title>Autocad Vespertino</title>
  <meta charset="utf-8">
...
<!------------------------------------------------------------*----------------------------------------------------------->
  <div id="titulo">
    <p id="header">Autocad Vespertino</p>
  </div>
  <br>
<!------------------------------------------------------------*----------------------------------------------------------->
<div id="modal_form">
...
@include('contentsadmin.content5')
@else
@endif
...
<br>
<br>
<form id="formulario_aula1" action="{{route('autocad_vespertino1')}}" method="POST" enctype="multipart/form-data">
  {{csrf_field()}}
<div id="logos">
  <div id="img1_estado">
...
<div id="titulo_form">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Número y Nombre Practica" required="" name="nombreprac_autocad_ves">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Unidad de Aprendizaje</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Unidad de Aprendizaje" required="" name="unidad_autocad_ves">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control"rows="6" required="" name="desarrollo_autocad_ves"></textarea>
  </div>
 <br>
 <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" placeholder="Número de Alumnos" required="" class='numalum' name="numalumnos_autocad_ves" onkeypress="return numeros(event)">
  ...
  <div class="form-group row">
    <div class="col-sm-4">
      <input type="date" name="fecha_reservacion_autocad_ves" class="form-control"   value="{{old('fecha_reservacion_autocad_ves',$now->format('Y-m-d'))}}" readonly="">
    </div>
    <div class="col-sm-4">
      <input type="time" name="hora_reservacion_autocad_ves" class="form-control"   value="{{old('hora_reservacion_autocad_ves',$now->format('H:i:s'))}}" readonly="">
    </div>
  </div>
...
<p style="font-size: 16px; font-weight: bold;">Ejemplo: Formato de llenado: 07-06-2019 03:00 pm</p>
 ...
 <div class="form-group row">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="10" required="" name="observaciones_autocad_ves"></textarea>
  </div>
  ...
  <center>
     <input class="btn btn-outline-primary " type="submit" name="guardar_aula2" value="Guardar">
...
<br>
<br>
<form id="formulario_aula1" action="{{route('autocad_vespertino1_')}}" method="POST" enctype="multipart/form-data">
  {{csrf_field()}}
<div id="logos">
  <div id="img1_estado">
    <img src="imagenes/estadodemexico.png" width="35%">
