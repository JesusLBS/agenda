...
<table>
	...
	<tr>
		<td>El Nuevo Usuario <b>{{$user['name']}}</b> se ha registrado y requiere Activación de la cuenta</td>
	...
	<tr>
		<td><br><br><br>Si tienes problemas abriendo este link "Agenda Electronica", copia y pega esto en tu navegador:http://localhost/agenda/public/ </td>
	</tr>
	<tr>
