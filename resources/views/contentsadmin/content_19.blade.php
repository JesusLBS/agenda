...
<html>
<head>
  <title>Display Users Activos</title>
  <meta charset="utf-8">
...
<div id="titulo">
  <br>
   <p id="header">Desactivación de Usuarios</p>
</div>
<!------------------------------------------------------------*----------------------------------------------------------->
<div id="agregaruser">
...
<center>
  <table>
    ...
    <tr> 
      ...
      <td data-label="Estado del Usuario"  style="color: green; font-weight: bold; text-align: center; font-size: 1em;">Activo</td>
      <td data-label="Acción"  class="user">
        <a  data-label="Registro" href="{{URL::action('usercontroller@desactivaruser',['id'=>$user1->id])}}" class="btn btn-warning" onclick="return confirm('¿Seguro que quieres Desactivar a {{$user1->name}} ?')">
          Desactivar
        </a>
