...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->nombreprac_auditorio_ves}}</td>
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->unidad_auditorio_ves}}</td>
    </tr>
    </table>
</center>
<br><br>
...
<textarea class="form-control" rows="10"  name="observaciones_auditorio_ves">{{$events->desarrollo_auditorio_ves}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
<table>
    <tr>
      ...
      <td>  {{$events->numalumnos_auditorio_ves}}</td>
    </tr>
</table>
</center>
...
<br>
<textarea class="form-control" rows="30"  name="observaciones_auditorio_ves">{{$events->observaciones_auditorio_ves}}</textarea>
<br>
<br>
<center>
