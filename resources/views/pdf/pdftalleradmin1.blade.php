...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->nombreprac_talleradmin_mat}}</td>
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->unidad_talleradmin_mat}}</td>
    </tr>
    </table>
</center>
<br><br>
...
<textarea class="form-control" rows="10"  name="observaciones_talleradmin_mat">{{$events->desarrollo_talleradmin_mat}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
<table>
    <tr>
      ...
      <td>  {{$events->numalumnos_talleradmin_mat}}</td>
    </tr>
</table>
</center>
...
<br>
<textarea class="form-control" rows="30"  name="observaciones_talleradmin_mat">{{$events->observaciones_talleradmin_mat}}</textarea>
<br>
<br>
<center>
