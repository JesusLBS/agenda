...
<table>
 ...
 <!--------------------->  
<div id="titulo_form">
    <p id="titulo_form_2">Laboratorio Informática No INFORMATICA VESPERTINO</p>
</div>
<br>
 <!------Tabla 2-------->
<center>
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->nombreprac_infor_ves}}</td>
    </tr>
    <tr>
...
<textarea class="form-control" rows="10"  name="observaciones_infor_ves">{{$events->desarrollo_infor_ves}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
<table>
    <tr>
      ...
      <td>  {{$events->numalumnos_infor_ves}}</td>
    </tr>
</table>
</center>
...
<br>
<textarea class="form-control" rows="30"  name="observaciones_infor_ves">{{$events->observaciones_infor_ves}}</textarea>
<br>
<br>
<center>
