...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->nombreprac_auditorio_mat}}</td>
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->unidad_auditorio_mat}}</td>
    </tr>
    </table>
</center>
<br><br>
...
<textarea class="form-control" rows="10"  name="observaciones_auditorio_mat">{{$events->desarrollo_auditorio_mat}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
<table>
    <tr>
      ...
      <td>  {{$events->numalumnos_auditorio_mat}}</td>
    </tr>
</table>
</center>
...
<br>
<textarea class="form-control" rows="30"  name="observaciones_auditorio_mat">{{$events->observaciones_auditorio_mat}}</textarea>
<br>
<br>
<center>
