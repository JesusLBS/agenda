...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->nombreprac_autocad_mat}}</td>
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->unidad_autocad_mat}}</td>
    </tr>
    </table>
</center>
<br><br>
...
<textarea class="form-control" rows="10"  name="observaciones_autocad_mat">{{$events->desarrollo_autocad_mat}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
<table>
    <tr>
      ...
      <td>  {{$events->numalumnos_autocad_mat}}</td>
    </tr>
</table>
</center>
...
<br> 
<textarea class="form-control" rows="30"  name="observaciones_autocad_mat">{{$events->observaciones_autocad_mat}}</textarea>
<br>
<br>
<center>
