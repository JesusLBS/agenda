...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events1->nombreprac_autocad_mat}}</td>
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events1->unidad_autocad_mat}}</td>
    </tr>
    </table>
</center>
@endforeach
...
<textarea class="form-control" rows="10"  name="observaciones_autocad_mat">{{$events1->desarrollo_autocad_mat}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
@foreach($events as $events1)
<table>
    <tr>
      ...
      <td>  {{$events1->numalumnos_autocad_mat}}</td>
    </tr>
</table>
@endforeach
...
<br> 
<textarea class="form-control" rows="30"  name="observaciones_autocad_mat">{{$events1->observaciones_autocad_mat}}</textarea>
<br>
<br>
<center>
