...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->nombreprac_talleradmin_ves}}</td>
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->unidad_talleradmin_ves}}</td>
    </tr>
    </table>
</center>
<br><br>
...
<textarea class="form-control" rows="10"  name="observaciones_talleradmin_ves">{{$events->desarrollo_talleradmin_ves}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
<table>
    <tr>
      ...
      <td>  {{$events->numalumnos_talleradmin_ves}}</td>
    </tr>
</table>
</center>
<br>
...
<br>
<textarea class="form-control" rows="30"  name="observaciones_talleradmin_ves">{{$events->observaciones_talleradmin_ves}}</textarea>
<br>
<br>
<center>
