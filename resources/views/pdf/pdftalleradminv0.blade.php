...
<table>
 ...
 <!--------------------->  
<div id="titulo_form">
    <p id="titulo_form_2">Taller de Administración No TALLER DE ADMINISTRACIÓN VESPERTINO</p>
</div>
<br>
 <!------Tabla 2-------->
<center>
...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events1->nombreprac_talleradmin_ves}}</td>
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events1->unidad_talleradmin_ves}}</td>
    </tr>
    </table>
</center>
@endforeach
...
<textarea class="form-control" rows="10"  name="observaciones_talleradmin_ves">{{$events1->desarrollo_talleradmin_ves}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
    @foreach($events as $events1)
...
<table>
    <tr>
      ...
      <td>  {{$events1->numalumnos_talleradmin_ves}}</td>
    </tr>
</table>
@endforeach
</center>
...
<br>
<textarea class="form-control" rows="30"  name="observaciones_talleradmin_ves">{{$events1->observaciones_talleradmin_ves}}</textarea>
<br>
</center>
<br>
<center>
