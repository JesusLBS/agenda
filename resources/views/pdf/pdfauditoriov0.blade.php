...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events1->nombreprac_auditorio_ves}}</td>
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events1->unidad_auditorio_ves}}</td>
    </tr>
    </table>
</center>
@endforeach
...
<textarea class="form-control" rows="10"  name="observaciones_auditorio_ves">{{$events1->desarrollo_auditorio_ves}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
    @foreach($events as $events1)
...
<table>
    <tr>
      ...
      <td>  {{$events1->numalumnos_auditorio_ves}}</td>
    </tr>
</table>
@endforeach
...
<br>
<textarea class="form-control" rows="30"  name="observaciones_auditorio_ves">{{$events1->observaciones_auditorio_ves}}</textarea>
<br>
</center>
<br>
<center>
