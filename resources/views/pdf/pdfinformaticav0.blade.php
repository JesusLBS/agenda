...
<html>
<head>
  <title>PDF Informática Vespertino</title>
  <meta charset="utf-8">
...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events1->nombreprac_infor_ves}}</td> 
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events1->unidad_infor_ves}}</td>
    </tr>
    </table>
</center>
@endforeach
...
<textarea class="form-control" rows="10"  name="observaciones_infor_ves">{{$events1->desarrollo_infor_ves}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
    @foreach($events as $events1)
...
<table>
    <tr>
      ...
      <td>  {{$events1->numalumnos_infor_ves}}</td>
    </tr>
</table>
@endforeach
...
<br>
<textarea class="form-control" rows="30"  name="observaciones_infor_ves">{{$events1->observaciones_infor_ves}}</textarea>
<br>
</center>
<br>
<center>
