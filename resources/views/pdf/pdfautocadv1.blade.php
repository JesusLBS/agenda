...
<table>
    ...
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->nombreprac_autocad_ves}}</td>
    </tr>
    <tr>
      ...
      <th></th>
      <th></th>
      <td>{{$events->unidad_autocad_ves}}</td>
    </tr>
    </table>
</center>
<br><br>
...
<textarea class="form-control" rows="10"  name="observaciones_autocad_ves">{{$events->desarrollo_autocad_ves}}</textarea>
<br>
 <!------Tabla 3-------->
<center>
<table>
    <tr>
      ...
      <td>  {{$events->numalumnos_autocad_ves}}</td>
    </tr>
</table>
</center>
...
<br>
<textarea class="form-control" rows="30"  name="observaciones_autocad_ves">{{$events->observaciones_autocad_ves}}</textarea>
<br>
<br>
<center>
