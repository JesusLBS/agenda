...
<!------------------------------------------------------------*----------------------------------------------------------->
  <div id="titulo">
    <p id="header">Autocad Matutino</p>
  </div>
  <br>
<!------------------------------------------------------------*----------------------------------------------------------->
...
@include('contentsadmin.content4')
@else
@endif
...
<br>
<br>
<form id="formulario_aula1" action="{{route('autocad_matutino1')}}" method="POST" enctype="multipart/form-data">
  {{csrf_field()}}
<div id="logos">
  <div id="img1_estado">
...
<div id="titulo_form">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Número y Nombre Practica" required="" name="nombreprac_autocad_mat">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Unidad de Aprendizaje</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Unidad de Aprendizaje" required="" name="unidad_autocad_mat">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control"rows="6" required="" name="desarrollo_autocad_mat"></textarea>
  </div>
 <br>
 <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" placeholder="Número de Alumnos" required="" name="numalumnos_autocad_mat" onkeypress="return numeros(event)">
    </div>
  </div>
  ...
  <div class="form-group row">
    <div class="col-sm-4">
      <input type="date" name="fecha_reservacion_autocad_mat" class="form-control"   value="{{old('fecha_reservacion_autocad_mat',$now->format('Y-m-d'))}}" readonly="">
    </div>
    <div class="col-sm-4">
      <input type="time" name="hora_reservacion_autocad_mat" class="form-control"   value="{{old('hora_reservacion_autocad_mat',$now->format('H:i:s'))}}" readonly="">
    </div>
  </div>
...
<p style="font-size: 16px; font-weight: bold;">Ejemplo: Formato de llenado: 07-06-2019 08:30 am</p>
 ...
 <div class="form-group row">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="10" required="" name="observaciones_autocad_mat"></textarea>
  </div>
...
<br>
<br>
<form id="formulario_aula1" action="{{route('autocad_matutino1_')}}" method="POST" enctype="multipart/form-data">
  {{csrf_field()}}
<div id="logos">
  <div id="img1_estado">
    <img src="imagenes/estadodemexico.png" width="35%">
