...
<br>
<br>
<form id="formulario_aula1" action="{{route('modulos1')}}" method="POST" enctype="multipart/form-data">
...
<div id="titulo_form">
    <p id="titulo_form_1">REGISTRO DE MÓDULO</p>
</div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Nombre de Módulo</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Nombre de Módulo" required="" name="nombre_modulo">
    </div>
  </div>
  <label class="radio-inline"><input type="radio" name="activo_modulo" value="1" checked>Activo</label>
  <label class="radio-inline"><input type="radio" name="activo_modulo" value="0">Inactivo</label>
  <center>
...
<center>
  <table>
    ...
    @foreach($modulo0 as $modulo1)
    <tr>
      <td data-label="ID">{{$modulo1->id_modulo}}</td>
      <td data-label="Nombre">{{$modulo1->nombre_modulo}}</td>
      <td data-label="Acción" class="modulo">
        <a href="{{URL::action('modulocontroller@desactivar',['id_modulo'=>$modulo1->id_modulo])}}" class="btn btn-danger" onclick="return confirm('¿Seguro que quieres desactivar el Módulo {{$modulo1->nombre_modulo}}?')">
          Desactivar
        </a>
        <a href="{{URL::action('modulocontroller@edit',['id_modulo'=>$modulo1->id_modulo])}}" class="btn btn-primary">
          Modificar
        </a>
      </td>
    </tr>
