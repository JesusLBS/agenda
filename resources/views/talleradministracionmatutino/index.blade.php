...
<html>
<head>
  <title>Taller de Administración Matutino</title>
  <meta charset="utf-8">
...
<!------------------------------------------------------------*----------------------------------------------------------->
  <div id="titulo">
    <p id="header">Taller de Administración Matutino</p>
  </div> 
  <br>
<!------------------------------------------------------------*----------------------------------------------------------->
<div id="modal_form">
...
@include('contentsadmin.content6')
@else
@endif
<!------------------------------------------------------------*----------------------------------------------------------->
<br>
...
<br>
<br>
<form id="formulario_aula1" action="{{route('administracion_matutino1')}}" method="POST" enctype="multipart/form-data">
...
<div id="titulo_form">
    <p id="titulo_form_1">Taller de  Administración No TALLER DE ADMINISTRACIÓN MATUTINO</p>
</div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Número y Nombre Practica" required="" name="nombreprac_talleradmin_mat">
    </div>
  </div>
  <div class="form-group row">
    <label class="col-sm-2 col-form-label">Unidad de Aprendizaje</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="Unidad de Aprendizaje" required="" name="unidad_talleradmin_mat">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control"rows="6" required="" name="desarrollo_talleradmin_mat"></textarea>
  </div>
 <br>
 <div class="form-group row">
    ...
    <div class="col-sm-3">
      <input type="text" class="form-control" placeholder="Número de Alumnos" required="" name="numalumnos_talleradmin_mat" onkeypress="return numeros(event)">
    </div>
  </div>
  ...
  <div class="form-group row">
    <div class="col-sm-4">
      <input type="date" name="fecha_reservacion_talleradmin_mat" class="form-control"   value="{{old('fecha_reservacion_talleradmin_mat',$now->format('Y-m-d'))}}" readonly="">
    </div>
    <div class="col-sm-4">
      <input type="time" name="hora_reservacion_talleradmin_mat" class="form-control"   value="{{old('hora_reservacion_talleradmin_mat',$now->format('H:i:s'))}}" readonly="">
    </div>
  </div>
...
<p style="font-size: 16px; font-weight: bold;">Ejemplo Formato de llenado: 07-06-2019 08:30 am</p>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="10" required="" name="observaciones_talleradmin_mat"></textarea>
  </div>
...
<br>
<br>
<form id="formulario_aula1" action="{{route('administracion_matutino1_')}}" method="POST" enctype="multipart/form-data">
  ...
  <div class="">
    ...
    <div class="colmd-8 col-md-offset-2">
      <div class="panel panel-default">
        ...
        Agenda Taller de Administración Matutino
        </div>
