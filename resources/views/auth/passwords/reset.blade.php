...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card" >
                <center>
                <div class="card-header" style="background-image: linear-gradient(to right,  rgb(0, 174, 63), rgb(191, 252, 231));font-weight: bold; ">{{ __('Restablecimiento de Password') }}</div>
                </center>
