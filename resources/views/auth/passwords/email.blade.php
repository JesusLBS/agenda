...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
              <center>
                <div class="card-header" id="reset" style="background-image: linear-gradient(to right,  rgb(0, 174, 63), rgb(191, 252, 231)); color: rgb(47, 50, 49);">{{ __('Restablecer Password') }}</div>
              </center>
